  ...
  return (
    ...
    >
      <Card.Body>
        ...
        <Card.Img variant="top" src={product.image} alt={product.name} className="mb-3" style={{ width: "100%", height: "auto" }} />
        ...
        <Button variant="warning" className="fw-bold w-100 rounded-pill py-2">AGREGAR</Button>
      </Card.Body>
    </Card>
  );
};
